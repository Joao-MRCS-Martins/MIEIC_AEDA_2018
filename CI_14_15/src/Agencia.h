...
public:
	...
	virtual bool eNormal() const {return false;};
...
public:
   ...
   bool eNormal() const {return true;}
};
...
public:
  ...
  bool levantamento(float valor);
  void deposito(float valor);
  bool eNormal() const {return false;}
};
...
public:
  ...
  bool operator < (const Agencia &a1) const;
  float operator()(const string &name) const;
