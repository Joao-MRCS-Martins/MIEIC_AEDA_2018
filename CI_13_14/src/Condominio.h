...
public:
	...
	int getAreaTotal() const {return Imovel::getAreaTotal();}
};
...
public:
	...
	bool operator > (const Urbanizacao &u1);
	static void resetID();
	static void resetID_i();
...
public:
	...
	vector<Imovel*> operator () (const string &s);
};
