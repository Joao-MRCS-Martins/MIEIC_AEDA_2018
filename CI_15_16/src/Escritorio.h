...
public:
   ...
   Documento operator +(const Documento & doc1);
};
...
public:
	...
	virtual bool eCores () const {return false;}
	virtual int getNumPaginasImprimir() const {return 0;}
};
...
public:
   ...
   bool eCores() const {return false;}
};
